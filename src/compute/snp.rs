...
struct Snp {}
impl Kernel<Particle, ([Real; 3], [Real; 3], [Real; 3])> for Snp {
    ...
    fn kernel(
        ...
        isrc: &[Particle],
        jsrc: &[Particle],
        idst: &mut [([Real; 3], [Real; 3], [Real; 3])],
        jdst: &mut [([Real; 3], [Real; 3], [Real; 3])],
    ) {
...
pub fn triangle(src: &[Particle]) -> Vec<([Real; 3], [Real; 3], [Real; 3])> {
